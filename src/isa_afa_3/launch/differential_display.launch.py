...
def generate_launch_description():
    ...
    default_model_path = os.path.join(
        pkg_share, "src", "description", "vehicle_differential.xacro"
    )
    default_rviz_config_path = os.path.join(pkg_share, "rviz", "config_differential.rviz")
    ...
    spawn_entity = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "entity_name": "vehicle_differential",
            "z": "10.0",
        }.items(),
    )
